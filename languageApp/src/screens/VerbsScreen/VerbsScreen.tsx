...
import { setAdvance_progress, setBeginner_progress, setIntermediate_progress } from '../../store/userSlice';
...
export const VerbsScreen: React.FC<VerbsProps> = ({navigation}) => {
  ...
  const {beginner_progress, intermediate_progress, advance_progress} = useSelector(
  ...
  return (
    <View>
      ...
      <SectionButton
        title="Beginner"
        onPress={() => {
          navigation.navigate('FlashCardsScreen', ["Beginner",beginner_progress])
        }}
      />
      <SectionButton
        title="Intermediate"
        onPress={() => {
          navigation.navigate('FlashCardsScreen',['Intermediate', intermediate_progress])
        }}
      />
      <SectionButton
        title="Advanced"
        onPress={() => {
          navigation.navigate('FlashCardsScreen',['Advance', advance_progress])
        }}
      />
    </View>
  );
